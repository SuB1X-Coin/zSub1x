...
In order to support loading of multiple wallets in zsub1x-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zsub1x.cpp.
...
Changes to zsub1x.cpp
----------------------
zsub1x.cpp is the entry point into zsub1x-qt, and as such, will require some minor modifications to provide hooks for
