...
RESOURCES += src/qt/zsub1x.qrc src/qt/zsub1x_locale.qrc

TRANSLATIONS += src/qt/locale/zsub1x_bg.ts \
                src/qt/locale/zsub1x_de.ts \
                src/qt/locale/zsub1x_en.ts \
                src/qt/locale/zsub1x_es.ts \
                src/qt/locale/zsub1x_fi.ts \
                src/qt/locale/zsub1x_fr.ts \
                src/qt/locale/zsub1x_it.ts \
                src/qt/locale/zsub1x_ja.ts \
                src/qt/locale/zsub1x_pl.ts \
                src/qt/locale/zsub1x_pt.ts \
                src/qt/locale/zsub1x_ru.ts \
                src/qt/locale/zsub1x_sk.ts \
                src/qt/locale/zsub1x_sv.ts \
                src/qt/locale/zsub1x_vi.ts \
                src/qt/locale/zsub1x_zh_CN.ts \
                src/qt/locale/zsub1x_zh_TW.ts
