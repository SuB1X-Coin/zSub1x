...
This issue tracker is only for technical issues related to zSub1x Core.
General zSub1x questions and/or support requests and are best directed to the [zSub1x Slack](http://zsub1x.slack.com).
...
### What version of zSub1x Core are you using?
