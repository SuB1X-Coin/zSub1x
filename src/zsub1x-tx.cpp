...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zSub1x Core zsub1x-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zsub1x-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zsub1x transaction") + "\n" +
                               "  zsub1x-tx [options] -create [commands]   " + _("Create hex-encoded zsub1x transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zsub1x transaction
