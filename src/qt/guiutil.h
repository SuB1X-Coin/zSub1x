...
/** Utility functions used by the zSub1x Qt UI.
 */
namespace GUIUtil
{
...
// Render zSub1x addresses in monospace font
...
// Parse "zsub1x:" URI into recipient object, return true on successful parsing
