                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("zSub1x Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zSub1x address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zsub1x: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSUB1X"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zSub1x Core"), this);
    aboutAction->setStatusTip(tr("Show information about zSub1x Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zSub1x"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zSub1x addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zSub1x addresses"));
    ...
    openAction->setStatusTip(tr("Open a zSub1x: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zSub1x Core help message to get a list with possible zSub1x command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zSub1x Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zSub1x network", "", count));
}
...
{
    QString strTitle = tr("zSub1x Core"); // default title
