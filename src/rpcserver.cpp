...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* zSub1x features */
        {"zsub1x", "masternode", &masternode, true, true, false},
        {"zsub1x", "listmasternodes", &listmasternodes, true, true, false},
        {"zsub1x", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zsub1x", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zsub1x", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zsub1x", "masternodedebug", &masternodedebug, true, true, false},
        {"zsub1x", "startmasternode", &startmasternode, true, true, false},
        {"zsub1x", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zsub1x", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zsub1x", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zsub1x", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zsub1x", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zsub1x", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zsub1x", "mnbudget", &mnbudget, true, true, false},
        {"zsub1x", "preparebudget", &preparebudget, true, true, false},
        {"zsub1x", "submitbudget", &submitbudget, true, true, false},
        {"zsub1x", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zsub1x", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zsub1x", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zsub1x", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zsub1x", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zsub1x", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zsub1x", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zsub1x", "checkbudgets", &checkbudgets, true, true, false},
        {"zsub1x", "mnsync", &mnsync, true, true, false},
        {"zsub1x", "spork", &spork, true, true, false},
        {"zsub1x", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zsub1x", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zsub1xd, or the -server option to zsub1x-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zsub1x-cli " + methodname + " " + args + "\n";
}
