...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! zSub1x is not connected
    ...
    RPC_WALLET_PASSSUB1XASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
