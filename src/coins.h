...
/** 
    ...
    ****Note - for zSub1x we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of zsub1x coming in to a transaction
