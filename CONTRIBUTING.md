Contributing to zSub1x Core
============================

The zSub1x Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zSub1x Core project, and is not to be
confused with overall zSub1x Network Protocol consensus changes.

Whether a pull request is merged into zSub1x Core rests with the project merge
...
Patches that change zSub1x consensus rules are considerably more involved than
...
Where a patch set proposes to change the zSub1x consensus, it must have been
...
The project leader is the release manager for each zSub1x Core release.
